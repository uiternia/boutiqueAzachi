                    ...
                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                      ...
                      <div class="flex flex-col items-center -m-2">
                        ...
                        <div class="flex justify-between p-2 w-full">
                          ...
                          <div><button type="submit" class="flex mx-auto text-white bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg">オーナー情報更新</button></div>
                        </div>
                         </div>
                        </form>
                    </div>
