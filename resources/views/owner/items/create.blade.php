                  ...
                  <div class="container px-5 py-24 mx-auto">
                    ...
                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                      ...
                      <div class="flex flex-col items-center -m-2">
                        ...
                        <div class="p-2 w-1/2">
                          <div class="relative">
                            <label for="quantity" class="leading-7 text-sm text-gray-600">初期在庫 Sサイズ</label>
                        ...
                        <div class="p-2 w-1/2">
                          <div class="relative">
                            <label for="quantitym" class="leading-7 text-sm text-gray-600">初期在庫 Mサイズ</label>
                            <input type="number" id="quantitym" name="quantitym" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                          </div>
                        </div>
                        <div class="p-2 w-1/2">
                          <div class="relative">
                            <label for="quantityl" class="leading-7 text-sm text-gray-600">初期在庫 Lサイズ</label>
                            <input type="number" id="quantityl" name="quantityl" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                          </div>
                        </div>
                        <div class="p-2 w-1/2">
                          <div class="relative">
                        ...
                        <div class="flex justify-between p-2 w-full">
                          ...
                          <div><button type="submit" class="flex mx-auto text-white bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg">オーナー情報登録</button></div>
                        </div>
                      </div>
                        </form>
                    </div>
